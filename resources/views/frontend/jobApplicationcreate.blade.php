    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.job-applications.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('linked_in_profile') ? 'is-invalid' : '' }}" type="text" name="linked_in_profile" id="linked_in_profile" value="{{ old('linked_in_profile', '') }}" required>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\JobApplication::HIGHEST_DEGREE_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('highest_degree') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="highest_degree_{{ $key }}" name="highest_degree" value="{{ $key }}" {{ old('highest_degree', '') === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('field_of_study') ? 'is-invalid' : '' }}" type="text" name="field_of_study" id="field_of_study" value="{{ old('field_of_study', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('high_school_name') ? 'is-invalid' : '' }}" type="text" name="high_school_name" id="high_school_name" value="{{ old('high_school_name', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('history_title') ? 'is-invalid' : '' }}" type="text" name="history_title" id="history_title" value="{{ old('history_title', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('history_type_of_institute') ? 'is-invalid' : '' }}" type="text" name="history_type_of_institute" id="history_type_of_institute" value="{{ old('history_type_of_institute', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('history_city') ? 'is-invalid' : '' }}" type="text" name="history_city" id="history_city" value="{{ old('history_city', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('history_country') ? 'is-invalid' : '' }}" type="text" name="history_country" id="history_country" value="{{ old('history_country', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('history_start_date') ? 'is-invalid' : '' }}" type="text" name="history_start_date" id="history_start_date" value="{{ old('history_start_date') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('history_end_date') ? 'is-invalid' : '' }}" type="text" name="history_end_date" id="history_end_date" value="{{ old('history_end_date') }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('history_reason_of_leaving') ? 'is-invalid' : '' }}" name="history_reason_of_leaving" id="history_reason_of_leaving" required>{{ old('history_reason_of_leaving') }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('current_notice_period') ? 'is-invalid' : '' }}" type="text" name="current_notice_period" id="current_notice_period" value="{{ old('current_notice_period', '') }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('best_candidate') ? 'is-invalid' : '' }}" name="best_candidate" id="best_candidate">{{ old('best_candidate') }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('race') ? 'is-invalid' : '' }}" type="text" name="race" id="race" value="{{ old('race', '') }}" required>
                @if($errors->has('race'))
                    <div class="invalid-feedback">
                        {{ $errors->first('race') }}
                    </div>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\JobApplication::AGE_GROUPS_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('age_groups') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="age_groups_{{ $key }}" name="age_groups" value="{{ $key }}" {{ old('age_groups', '') === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\JobApplication::RELIGION_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('religion') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="religion_{{ $key }}" name="religion" value="{{ $key }}" {{ old('religion', '') === (string) $key ? 'checked' : '' }} required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('disability_yes') ? 'is-invalid' : '' }}" type="text" name="disability_yes" id="disability_yes" value="{{ old('disability_yes', '') }}">
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\JobApplication::KNOW_US_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('know_us') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="know_us_{{ $key }}" name="know_us" value="{{ $key }}" {{ old('know_us', '') === (string) $key ? 'checked' : '' }}>
