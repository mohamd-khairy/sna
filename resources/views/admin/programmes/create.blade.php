...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.programmes.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label class="required" for="name_ar">{{ trans('cruds.programme.fields.name_ar') }}</label>
            ...
            <div class="form-group">
                <label class="required" for="price">{{ trans('cruds.programme.fields.price') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.programme.fields.price_helper') }}</span>
            </div>
            <div class="form-group">
                <div class="form-check {{ $errors->has('active') ? 'is-invalid' : '' }}">
                    ...
                    <label class="form-check-label" for="active">{{ trans('cruds.programme.fields.active') }}</label>
                </div>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.programme.fields.active_helper') }}</span>
            </div>
            <div class="form-group">
