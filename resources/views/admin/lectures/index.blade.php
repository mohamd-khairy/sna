...
<div class="card">
    <div class="card-header">
        {{ trans('cruds.lecture.title_singular') }} {{ trans('global.list') }}
    </div>
...
@can('lecture_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.lectures.massDestroy') }}",
...
@endcan
  ...
  let table = $('.datatable-Lecture:not(.ajaxTable)').DataTable({ buttons: dtButtons })
