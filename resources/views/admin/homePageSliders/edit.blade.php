...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.homePageSlider.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.home-page-sliders.update", [$homePageSlider->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="title">{{ trans('cruds.homePageSlider.fields.title') }}</label>
                <input class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" type="text" name="title" id="title" value="{{ old('title', $homePageSlider->title) }}" required>
                @if($errors->has('title'))
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('content_ar') ? 'is-invalid' : '' }}" name="content_ar" id="content_ar">{!! old('content_ar', $homePageSlider->content_ar) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('content_en') ? 'is-invalid' : '' }}" name="content_en" id="content_en">{!! old('content_en', $homePageSlider->content_en) !!}</textarea>
