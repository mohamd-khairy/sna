    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.users.update", [$user->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('program') ? 'is-invalid' : '' }}" name="program_id" id="program_id">
                    @foreach($programs as $id => $program)
                        <option value="{{ $id }}" {{ (old('program_id') ? old('program_id') : $user->program->id ?? '') == $id ? 'selected' : '' }}>{{ $program }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('full_name_en') ? 'is-invalid' : '' }}" type="text" name="full_name_en" id="full_name_en" value="{{ old('full_name_en', $user->full_name_en) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('full_name_ar') ? 'is-invalid' : '' }}" type="text" name="full_name_ar" id="full_name_ar" value="{{ old('full_name_ar', $user->full_name_ar) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('national') ? 'is-invalid' : '' }}" type="text" name="national" id="national" value="{{ old('national', $user->national) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('birth_date') ? 'is-invalid' : '' }}" type="text" name="birth_date" id="birth_date" value="{{ old('birth_date', $user->birth_date) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('birth_country') ? 'is-invalid' : '' }}" type="text" name="birth_country" id="birth_country" value="{{ old('birth_country', $user->birth_country) }}" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('undergraduate') ? 'is-invalid' : '' }}" name="undergraduate" id="undergraduate" required>
                    ...
                    @foreach(App\Models\User::UNDERGRADUATE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('undergraduate', $user->undergraduate) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('personal_statement') ? 'is-invalid' : '' }}" type="text" name="personal_statement" id="personal_statement"  required>{{ old('personal_statement', $user->personal_statement) }}</textarea>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\User::KNOW_US_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('know_us') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="know_us_{{ $key }}" name="know_us" value="{{ $key }}" {{ old('know_us', $user->know_us) === (string) $key ? 'checked' : '' }} required>
