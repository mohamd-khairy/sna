...
<div class="card">
    <div class="card-header">
        {{ trans('cruds.founder.title_singular') }} {{ trans('global.list') }}
    </div>
...
@can('founder_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.founders.massDestroy') }}",
...
@endcan
  ...
  let table = $('.datatable-Founder:not(.ajaxTable)').DataTable({ buttons: dtButtons })
