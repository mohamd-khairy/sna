...
<div class="card">
    <div class="card-header">
        {{ trans('cruds.blogscomment.title_singular') }} {{ trans('global.list') }}
    </div>

    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-Blogscomment">
                <thead>
                    <tr>
                        <th width="10">
...
@can('blogscomment_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.blogscomments.massDestroy') }}",
...
@endcan
  ...
  let table = $('.datatable-Blogscomment:not(.ajaxTable)').DataTable({ buttons: dtButtons })
